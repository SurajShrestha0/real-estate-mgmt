...
export default function Profile() {
  ...
  const handleShowListings = async () => {
    try {
      ...
      // Check if data contains listings array
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <img
          ...
          src={formData.avatar || currentUser.avatar} // Use currentUser.avatar
          alt="Profile"
            ...
            >
              <Link to={`/listing/${listing._id}`}>
                <img
                  ...
                  alt="listing cover"
                  className="h-16 w-16 object-conatin"
                />
              </Link>
              <Link
                className="flex-1 text-slate-700 font-semi-bold hover:underline truncate"
