...
export default interface INotificationsStoresCollection {
     ...
     */
    fetchStore: (storeId: string, queryParams?: Record<string, unknown>, options?: Partial<{
        reset: boolean;
        prepend: boolean;
    }>) => Promise<void>;
    /**
     ...
     * @param options.reset Whether to prepend notifications to the store or not
     */
    fetchAllStores: (queryParams?: Record<string, unknown>, options?: Partial<{
        reset: boolean;
        prepend: boolean;
    }>) => Promise<void>;
    /**
     ...
     * @param notification
     */
    archiveNotification: (notification: IRemoteNotification, options?: Partial<{
        persist: boolean;
    }>) => Promise<boolean>;
    /**
     ...
     * @param notification
     */
    unarchiveNotification: (notification: IRemoteNotification, options?: Partial<{
        persist: boolean;
    }>) => Promise<boolean>;
    /**
     ...
     * @param notification Notification to mark as read.
     */
    deleteNotification: (notification: IRemoteNotification, options?: Partial<{
        persist: boolean;
    }>) => Promise<boolean>;
    /**
