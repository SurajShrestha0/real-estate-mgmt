 ...
 */
export declare function subscribeToPushNotifications(pushManager: PushManager, publicKey: string): Promise<PushSubscription>;
/**
 ...
 * @param project
 */
export declare function createPushSubscription(pushManager: PushManager, config: IRemoteConfig): Promise<unknown>;
/**
 ...
 */
export declare function createSafariPushSubscription(authenticationToken: string, webServiceUrl: string, websitePushID?: string): Promise<unknown>;
