 ...
 */
export declare function secondsToDate(seconds: number | null): dayjs.Dayjs;
/**
 * Function to build a Date given a string or number of milliseconds.
 *
 * @example toDate('2020-02-01')
 */
export declare function toDate(date: string | number | Dayjs | Date): dayjs.Dayjs;
/**
 ...
 */
export declare function toUnix(date?: string | number | Dayjs | Date): number;
