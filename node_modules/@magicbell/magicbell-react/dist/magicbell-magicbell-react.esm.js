...
import { useBell, useConfig, clientSettings, useNotification, useNotifications, useNotificationPreferences, MagicBellProvider as MagicBellProvider$1, useMagicBellEvent } from "@magicbell/react-headless";
import { clientSettings as clientSettings2, eventAggregator, useMagicBellEvent as useMagicBellEvent2, useNotification as useNotification2, useNotificationPreferences as useNotificationPreferences2, useNotificationStoresCollection, useNotificationUnmount, useNotifications as useNotifications2 } from "@magicbell/react-headless";
import { createContext, useContext, useMemo, useCallback, Children, forwardRef, useRef, useEffect, useState, Fragment as Fragment$1 } from "react";
import useToggle from "react-use/lib/useToggle";
import { jsx as jsx$1, jsxs as jsxs$1 } from "@emotion/react/jsx-runtime";
import { unapply, pipe, filter, compose, not, isNil, reduce, mergeDeepRight, pathOr, path } from "ramda";
...
const MagicBellContext = createContext({});
...
const merge = unapply(pipe(filter(compose(not, isNil)), reduce(mergeDeepRight, {})));
const fonts$1 = {
...
const MagicBellThemeContext = createContext(defaultTheme);
function MagicBellThemeProvider(_a) {
  ...
  return /* @__PURE__ */ jsx(MagicBellThemeContext.Provider, __spreadValues({ value: theme }, props));
}
...
function Badge({ count }) {
  ...
  `;
  return /* @__PURE__ */ jsx$1("span", { css: [cleanslate$1, style], children: /* @__PURE__ */ jsx$1("div", { "aria-label": `${count} unread items`, "aria-live": "polite", role: "status", children: count }) });
}
  ...
  return /* @__PURE__ */ jsx$1(
    "div",
    {
      css: css`
        ...
        left: 80%;
      `,
      children: /* @__PURE__ */ jsx$1(Badge, { count })
    }
  );
}
function BellIcon$1() {
  const { icon: theme } = useTheme();
  return /* @__PURE__ */ jsxs("svg", { width: theme.width, height: theme.width, viewBox: "0 0 27 27", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    /* @__PURE__ */ jsx(
      "path",
      {
...
function Bell({ Icon, Badge: Badge2 = BellBadge, onClick, storeId, counter }) {
  ...
  `;
  if (isFetchingConfig) {
    return /* @__PURE__ */ jsx$1("div", { css: [cleanslate$1, containerStyle] });
  }
  return /* @__PURE__ */ jsxs$1(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsx$1("div", { css: iconStyle, children: !isNil(Icon) ? Icon : /* @__PURE__ */ jsx$1(BellIcon$1, {}) }),
        notifications && /* @__PURE__ */ jsx$1(Badge2, { count: counter === "unread" ? notifications == null ? void 0 : notifications.unreadCount : notifications == null ? void 0 : notifications.unseenCount })
      ]
    }
  );
}
...
function useTranslate() {
  ...
  return useCallback(
    (id, defaultMessage) => pathOr(defaultMessage, id.split("."), translations),
    [translations]
  );
}
...
function Text({ id, defaultMessage, html = false }) {
  ...
  if (html)
    return /* @__PURE__ */ jsx("span", { dangerouslySetInnerHTML: { __html: localizedText } });
  return /* @__PURE__ */ jsx(Fragment, { children: localizedText });
}
function CloseIcon() {
  return /* @__PURE__ */ jsx(
    "svg",
...
function CloseBannerButton({ onClick }) {
  ...
  return /* @__PURE__ */ jsx$1(
    "button",
    {
      ...
      `,
      children: /* @__PURE__ */ jsx$1(CloseIcon, {})
    }
  );
}
function EnablePushNotificationsButton({ onClick }) {
  ...
  return /* @__PURE__ */ jsx$1(
    "button",
    {
      ...
      `,
      onClick: handleClick,
      children: /* @__PURE__ */ jsx$1(Text, { id: "web-push-notifications.enable-now", defaultMessage: "Enable Now" })
    }
  );
}
function EnablePushNotificationsBanner() {
  ...
  return /* @__PURE__ */ jsxs$1(
    "div",
    {
      ...
      `,
      children: [
        /* @__PURE__ */ jsx$1("p", { style: { flex: 1 }, children: /* @__PURE__ */ jsx$1(
          Text,
          {
        ...
        /* @__PURE__ */ jsx$1(EnablePushNotificationsButton, { onClick: enablePushNotifications }),
        /* @__PURE__ */ jsx$1(CloseBannerButton, { onClick: closeBanner })
      ]
    }
  );
}
...
function FooterLogo() {
  ...
  `;
  if (hideBranding)
    return /* @__PURE__ */ jsx$1("div", { css: style });
  return /* @__PURE__ */ jsx$1("div", { css: style, children: /* @__PURE__ */ jsx$1("a", { href: "https://magicbell.io/?utm_source=widget", target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsx$1(MagicBellLogo, {}) }) });
}
function StyledFooter({ children }) {
  ...
  `;
  return /* @__PURE__ */ jsx$1("div", { css: [cleanslate$1, style], children });
}
function Footer({ children }) {
  ...
  `;
  return /* @__PURE__ */ jsx$1(StyledFooter, { children: /* @__PURE__ */ jsxs$1("div", { css: contentStyle, children: [
    /* @__PURE__ */ jsx$1(FooterLogo, {}),
    children
  ] }) });
}
function SettingsIcon() {
  return /* @__PURE__ */ jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx(
    "path",
    {
      fillRule: "evenodd",
      clipRule: "evenodd",
...
function Header({ title, actions }) {
  return /* @__PURE__ */ jsxs$1(StyledHeader, { children: [
    /* @__PURE__ */ jsx$1(
      "div",
      {
        role: "heading",
...
function Tabs({
  ...
  `;
  return /* @__PURE__ */ jsx$1("div", { css: style, role: "tablist", children: Children.toArray(children).filter(isTab).map((child, idx) => __spreadProps(__spreadValues({}, child), {
...
function Tab(_c) {
  ...
  `;
  return /* @__PURE__ */ jsx$1("button", __spreadProps(__spreadValues({}, props), { css: style, role: "tab", "aria-selected": Boolean(props["data-selected"]), children: typeof children === "string" ? /* @__PURE__ */ jsx$1(Text, { id: `tab.${value}`, defaultMessage: children }) : children }));
}
Tabs.Tab = Tab;
function HeaderTabs({ tabsConfig, activeTab, onChange }) {
  return /* @__PURE__ */ jsx(Tabs, { active: activeTab, onChange, children: tabsConfig == null ? void 0 : tabsConfig.map(({ storeId, label }) => /* @__PURE__ */ jsx(Tabs.Tab, { value: storeId, children: label }, storeId)) });
}
function Popover(_e) {
  var _f = _e, {
    closeOnClick = false,
...
function Tooltip(_g) {
  ...
  `;
  return /* @__PURE__ */ jsx$1(Popover, __spreadProps(__spreadValues({ launcher: children, placement }, props), { children: () => /* @__PURE__ */ jsx$1("span", { css: tipStyle, children: tooltip }) }));
}
const IconButton = forwardRef(function IconButton2(_i, ref) {
  var _j = _i, { children, tooltip, tooltipPlacement = "bottom-end" } = _j, props = __objRest(_j, ["children", "tooltip", "tooltipPlacement"]);
  return /* @__PURE__ */ jsx(Tooltip, { tooltip: tooltip || props["aria-label"], placement: tooltipPlacement, delay: 500, children: /* @__PURE__ */ jsx("button", __spreadProps(__spreadValues({ ref }, props), { children })) });
});
...
function ClearInboxMessage() {
  ...
  return /* @__PURE__ */ jsxs$1(
    "div",
    {
      ...
      `,
      children: [
        /* @__PURE__ */ jsx$1("p", { children: /* @__PURE__ */ jsx$1(Text, { id: "messages.empty-inbox", defaultMessage: "All clear!<br>We'll let you know when there's more.", html: true }) }),
        /* @__PURE__ */ jsx$1("img", { src: (images == null ? void 0 : images.emptyInboxUrl) || "https://assets.magicbell.io/images/empty_inbox.png", alt: "No notifications" })
      ]
    }
  );
}
function Layout({ order, children }) {
  return /* @__PURE__ */ jsx(Fragment, { children: order.map((key) => children.find((child) => (child == null ? void 0 : child.key) === key)) });
}
function useProse() {
...
function NotificationContent({ notification, prose: withProse = true }) {
  ...
  `;
  return /* @__PURE__ */ jsx$1("article", { ref, css: withProse ? [style, prose2] : style, dangerouslySetInnerHTML: { __html: markup } });
}
function MenuIcon() {
  return /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    /* @__PURE__ */ jsx("circle", { cx: "18", cy: "12", r: "1.5", fill: "currentColor" }),
    /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "1.5", fill: "currentColor" }),
    /* @__PURE__ */ jsx("circle", { cx: "6", cy: "12", r: "1.5", fill: "currentColor" })
  ] });
}
function NotificationContextMenu({ notification }) {
  ...
  return /* @__PURE__ */ jsxs$1(
    "div",
    {
      ...
      `,
      children: [
        /* @__PURE__ */ jsx$1("button", { type: "button", onClick: toggleRead, children: notification.isRead ? /* @__PURE__ */ jsx$1(Text, { id: "notification.mark-as-unread", defaultMessage: "Mark as unread" }) : /* @__PURE__ */ jsx$1(Text, { id: "notification.mark-as-read", defaultMessage: "Mark as read" }) }),
        /* @__PURE__ */ jsx$1("button", { type: "button", onClick: handleDelete, children: /* @__PURE__ */ jsx$1(Text, { id: "notification.delete", defaultMessage: "Delete" }) })
      ]
    }
  );
}
function NotificationMenu({ notification, menuPlacement = "bottom-end" }) {
  ...
  const launcher = /* @__PURE__ */ jsx$1(
    "button",
    {
      ...
      `,
      onClick: (e) => e.preventDefault(),
      children: /* @__PURE__ */ jsx$1(MenuIcon, {})
    }
  );
  return /* @__PURE__ */ jsx$1(
    Popover,
    {
      ...
      zIndex: 1,
      trigger: "click",
      children: () => /* @__PURE__ */ jsx$1(NotificationContextMenu, { notification })
    }
  );
}
function DotIcon() {
  return /* @__PURE__ */ jsx("svg", { width: "6", height: "6", viewBox: "0 0 6 6", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("circle", { cx: "3", cy: "3", r: "3", fill: "currentColor" }) });
}
function NotificationState({ notification }) {
  ...
  return /* @__PURE__ */ jsx$1(
    "div",
    {
      ...
      `,
      children: /* @__PURE__ */ jsx$1(DotIcon, {})
    }
  );
}
...
function Timestamp({ date, tooltipPlacement = "bottom-end", delay = 250 }) {
  ...
  const [relativeTime2, setRelativeTime] = useState(dateObj.fromNow(true));
  useInterval(() => setRelativeTime(dateObj.fromNow(true)), 6e4);
  return /* @__PURE__ */ jsx(Tooltip, { tooltip: dateObj.format("LL LT"), placement: tooltipPlacement, delay, children: /* @__PURE__ */ jsx("div", { children: relativeTime2 }) });
}
...
function StyledContainer$1(_k) {
  ...
  `;
  return /* @__PURE__ */ jsx$1("div", __spreadProps(__spreadValues({ css: [cleanslate$1, style] }, props), { children }));
}
function ClickableNotification({ notification: rawNotification, onClick, prose: prose2 }) {
  ...
  return /* @__PURE__ */ jsxs$1(
    StyledContainer$1,
    {
      ...
      onClick: handleClick,
      children: [
        /* @__PURE__ */ jsx$1(NotificationState, { notification }),
        /* @__PURE__ */ jsxs$1("div", { css: content, children: [
          /* @__PURE__ */ jsx$1(NotificationTitle, { notification }),
          /* @__PURE__ */ jsx$1(NotificationContent, { notification, prose: prose2 })
        ] }),
        /* @__PURE__ */ jsxs$1("div", { css: actions, children: [
          notification.sentAt ? /* @__PURE__ */ jsx$1(Timestamp, { date: notification.sentAt, tooltipPlacement: "left" }) : /* @__PURE__ */ jsx$1("div", {}),
          /* @__PURE__ */ jsx$1(NotificationMenu, { notification })
        ] })
      ]
    }
  );
...
function NotificationList({
  ...
  `;
  return /* @__PURE__ */ jsx$1("div", { css: style, children: /* @__PURE__ */ jsx$1(
    InfiniteScroll,
    {
      dataLength: store.notifications.length,
      hasMore: store.hasNextPage,
      next: () => store.fetchNextPage(queryParams),
      loader: /* @__PURE__ */ jsx$1(Loader, {}),
      height,
      scrollableTarget,
      children: store.notifications.map((notification) => /* @__PURE__ */ jsx$1(ListItem, { notification, onClick: onItemClick }, notification.id))
    }
  ) });
}
function NotificationInboxContent({
  ...
  return /* @__PURE__ */ jsx$1("div", { ref: setContentRef, css: { width: "100%", height: height != null ? height : "100%", overflow: "auto" }, children: contentRef ? /* @__PURE__ */ jsx$1(
    NotificationList,
    {
...
function NotificationsView({
  ...
  const [activeStore, setActiveStore] = useState(storeId || (tabsConfig == null ? void 0 : tabsConfig[0].storeId));
  const store = useNotifications(activeStore);
  if (!store)
    return null;
  const hasNotifications = !store.isEmpty;
  const showPreferencesButton = notificationPreferencesEnabled != null ? notificationPreferencesEnabled : pathOr(true, ["features", "notificationPreferences", "enabled"], config.inbox);
  const handleMarkAllAsRead = () => {
    store == null ? void 0 : store.markAllAsRead();
    onAllRead == null ? void 0 : onAllRead();
  };
  const showTabs = tabsConfig && activeStore;
  const tabs2 = showTabs ? /* @__PURE__ */ jsx$1(HeaderTabs, { activeTab: activeStore, onChange: setActiveStore, tabsConfig }) : null;
  const title = /* @__PURE__ */ jsx$1(Text, { id: "header.title", defaultMessage: "Notifications" });
  return /* @__PURE__ */ jsxs$1(Layout, { order: layout, children: [
    /* @__PURE__ */ jsx$1(
      Header,
      {
        title: showTabs ? tabs2 : title,
        actions: /* @__PURE__ */ jsxs$1(Fragment$1, { children: [
          hasNotifications ? /* @__PURE__ */ jsx$1(IconButton$1, { onClick: handleMarkAllAsRead, "aria-label": t("header.mark-all-read", "Mark all read"), children: /* @__PURE__ */ jsx$1(CheckMarkIcon, {}) }) : null,
          showPreferencesButton ? /* @__PURE__ */ jsx$1(
            IconButton$1,
            {
              onClick: () => setView("preferences"),
              "aria-label": t("preferences.toggle", "Notification preferences"),
              children: /* @__PURE__ */ jsx$1(SettingsIcon, {})
            }
          ) : null
        ] })
      },
    ...
    /* @__PURE__ */ jsx$1("div", { css: { flex: 1, overflowY: "hidden" }, children: !store.lastFetchedAt ? null : hasNotifications ? /* @__PURE__ */ jsx$1(
    ...
    ) : /* @__PURE__ */ jsx$1(EmptyInboxPlaceholder, {}) }, "content"),
    /* @__PURE__ */ jsx$1(EnablePushNotificationsBanner, {}, "push-notifications-banner"),
    /* @__PURE__ */ jsx$1(Footer, {}, "footer")
  ] });
}
function ToggleInput({ id, label, value = false, onClick }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    label ? /* @__PURE__ */ jsx("label", { htmlFor: id, style: { marginRight: "14px" }, children: label }) : null,
    /* @__PURE__ */ jsx("input", { id, type: "checkbox", onClick: handleClick, defaultChecked: value })
  ] });
}
function CategoryPreferences({ category, onChange }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { children: t(`preferences.categories.${category.slug}`, category.label) }),
    channels.map((channel) => /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
      ToggleInput,
      {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs$1(
        ...
        `,
          children: [
            /* @__PURE__ */ jsx$1("div", {}),
            channelHeaders.map((header2) => /* @__PURE__ */ jsx$1("div", { css: headerStyle, children: header2.label }, header2.slug)),
            categories.map((category) => /* @__PURE__ */ jsx$1(CategoryPreferences, { category, onChange }, category.slug))
          ]
        }
      )
    }
...
function PreferencesView({
  ...
  return /* @__PURE__ */ jsxs$1(Layout, { order: layout, children: [
    /* @__PURE__ */ jsx$1(
      Header,
      {
        title: /* @__PURE__ */ jsx$1(Text, { id: "preferences.title", defaultMessage: "Preferences" }),
        actions: /* @__PURE__ */ jsx$1(IconButton$1, { onClick: () => setView("inbox"), "aria-label": t("preferences.close", "Close preferences"), children: /* @__PURE__ */ jsx$1(CloseIcon, {}) })
      },
      "header"
    ),
    /* @__PURE__ */ jsx$1("div", { css: { flex: 1, overflowY: "hidden" }, children: /* @__PURE__ */ jsx$1(NotificationPreferences, {}) }, "content"),
    /* @__PURE__ */ jsx$1(Footer, {}, "footer")
  ] });
}
...
function NotificationInbox(_m) {
  ...
  if (isFetchingConfig)
    return null;
  return /* @__PURE__ */ jsx(StyledContainer, { height, layout, children: view === "preferences" ? /* @__PURE__ */ jsx(PreferencesView, __spreadProps(__spreadValues({}, props), { layout, setView })) : /* @__PURE__ */ jsx(NotificationsView, __spreadProps(__spreadValues({}, props), { tabs: tabs2, layout, setView })) });
}
...
function FloatingInboxContainer({
  ...
  return /* @__PURE__ */ jsx(
    Popover,
    {
      ...
      placement,
      popperOptions,
      children: (attrs) => /* @__PURE__ */ jsxs(StyledPopoverContainer, { width, attrs, layout, children: [
        children,
        hideArrow ? null : /* @__PURE__ */ jsx(Arrow, { placement: attrs["data-placement"] })
      ] })
    }
  );
}
function FloatingNotificationInbox(_o) {
  ...
  return /* @__PURE__ */ jsx(
    FloatingInboxContainer,
    {
      ...
      hideArrow,
      layout,
      children: /* @__PURE__ */ jsx(NotificationInbox, __spreadValues({ onNotificationClick: handleNotificationClick, layout }, inboxProps))
    }
  );
}
const NO_PROVIDER = "MAGICBELL_NO_PROVIDER";
const CurrentProviderContext = createContext(NO_PROVIDER);
...
function MagicBellProvider(_q) {
  ...
  return /* @__PURE__ */ jsx(MagicBellProvider$1, __spreadProps(__spreadValues(__spreadValues({}, internals), settings), { children: /* @__PURE__ */ jsx(SettingsProviders, __spreadProps(__spreadValues({}, settings), { theme, images, locale, children })) }));
}
function SettingsProviders(_s) {
  ...
  return /* @__PURE__ */ jsx(CurrentProviderContext$1.Provider, { value: "DEFAULT_MAGICBELL", children: /* @__PURE__ */ jsx(TranslationsProvider, { value: textTranslations, children: /* @__PURE__ */ jsx(MagicBellThemeProvider, { value: theme || config.theme, children: /* @__PURE__ */ jsx(MagicBellContext$1.Provider, { value: { images: images || config.images, isFetchingConfig }, children }) }) }) });
}
function MagicBellChildrenWrapper(_u) {
  var _v = _u, { children, apiKey } = _v, settings = __objRest(_v, ["children", "apiKey"]);
  const currentContext = useContext(CurrentProviderContext$1);
  if (currentContext === NO_PROVIDER) {
    if (!apiKey)
      return null;
    return /* @__PURE__ */ jsx(MagicBellProvider, __spreadProps(__spreadValues({ apiKey }, settings), { children }));
  }
  return /* @__PURE__ */ jsx(Fragment, { children });
}
const defaultInbox = (props) => /* @__PURE__ */ jsx(FloatingNotificationInbox, __spreadValues({ height: 500 }, props));
function MagicBell(_w) {
  ...
  return /* @__PURE__ */ jsx(MagicBellChildrenWrapper, __spreadProps(__spreadValues({}, settings), { children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { ref: launcherRef, "aria-expanded": isOpen, children: /* @__PURE__ */ jsx(Bell, { onClick: handleToggle, Icon: BellIcon2, Badge: Badge2, counter: bellCounter }) }),
...
export {
  Badge,
  Bell,
  BellIcon$1 as BellIcon,
  BellIcon as ClassicBellIcon,
  ClickableNotification,
  EnablePushNotificationsButton,
  FloatingInboxContainer,
  FloatingNotificationInbox,
  Arrow as FloatingNotificationInboxArrow,
  Footer,
  Header,
  MagicBellContext$1 as MagicBellContext,
  MagicBellProvider,
  MagicBellThemeContext$1 as MagicBellThemeContext,
  NotificationContent,
  NotificationInbox,
  NotificationList,
  PreferencesCategories as NotificationPreferences,
  NotificationState,
  Popover,
  PushNotificationsSubscriber,
  StyledContainer$1 as StyledNotificationContainer,
  Timestamp,
  classicTheme,
  clientSettings2 as clientSettings,
  darken,
  MagicBell as default,
  defaultTheme as defaultMagicBellTheme,
  eventAggregator,
  flatTheme,
  lightTheme,
  merge,
  toRGBA,
  useMagicBellContext,
  useMagicBellEvent2 as useMagicBellEvent,
  useNotification2 as useNotification,
  useNotificationPreferences2 as useNotificationPreferences,
  useNotificationStoresCollection,
  useNotificationUnmount,
  useNotifications2 as useNotifications,
  useTheme
};
//# sourceMappingURL=magicbell-magicbell-react.esm.js.map
